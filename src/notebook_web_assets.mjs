...
export const NOTEBOOK_WEB_ASSETS = new Map([
  ...
  ...['notebook-canvas', 'notebook-editor', 'notebook-review', 'notebook-views', 'assistant', 'assistant-drafts', 'assistant-audio'].map(name => ['/assets/ui/' + name + '.mjs', { file: 'ui/' + name + '.mjs', type: 'text/javascript; charset=utf-8' }]),
