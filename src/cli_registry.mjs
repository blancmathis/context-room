...
export const CLI_COMMAND_REGISTRY = freeze([
  ...
  define("context ask", { summary: "Research accepted documentation with a fresh read-only agent.", arguments: [positional("task"), option("--root"), option("--repository"), option("--project"), option("--goal"), option("--files"), option("--depth"), option("--budget", { value: "integer" }), option("--json", { value: "boolean" })], scopes: ["shared", ...PROJECT_SCOPES], formats: ["human", "json"], handlerKey: "context.ask", ui: "both" }),
