...
export const CLI_COMMAND_REGISTRY = freeze([
  ...
  define("ui list", { summary: "List active Context Room workspaces without exposing drafts.", arguments: [...TARGET, ...PAGE], scopes: ["device", ...PROJECT_SCOPES], handlerKey: "ui.list", ui: "both", effect: "none" }),
  define("ui open", { summary: "Open or navigate one exact Context Room workspace.", arguments: [...TARGET, option("--workspace"), option("--file"), option("--view"), option("--heading"), option("--text")], scopes: ["device", ...PROJECT_SCOPES], handlerKey: "ui.open", ui: "both", effect: "ephemeral", mutation: "mutating", authority: "ui-navigation" }),

  define("watch set", { summary: "Set or remove one explicit folder watch rule.", arguments: [positional("path"), option("--mode", { value: "recursive-live|recursive-current|direct-current|direct-live|off" }), ...TARGET, option("--dry-run", { value: "boolean" }), option("--apply")], scopes: ["project", "folder"], mutation: "mutating", protocol: "effect-aware", handlerKey: "watch.set", ui: "both", effect: "protected" }),
  ...
  define("agent unwatch", { summary: "Remove an explicit folder watch rule.", arguments: [option("--root"), option("--path", { required: true }), ...APPLY], scopes: ["project", "folder"], mutation: "mutating", protocol: "legacy-direct-with-preview", handlerKey: "agent.unwatch", ui: "both", exposure: "compatibility", replacement: "watch set --mode off" }),
