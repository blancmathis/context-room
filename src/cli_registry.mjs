...
export const CLI_COMMAND_REGISTRY = freeze([
  ...
  define("migrate", { summary: "Preview versioned state migration or a private Lisière recovery export; apply the exact revision with recoverable backups.", arguments: [...TARGET, option("--plan", { value: "boolean", description: "Preview only; also the default." }), option("--apply", { value: "boolean" }), option("--revision"), option("--export-lisiere", { description: "Legacy directory containing workspace.sqlite; exports recovery data without starting the old service." }), option("--output", { description: "Private export directory outside the legacy source; required with --export-lisiere." })], scopes: [...PROJECT_SCOPES, "device"], mutation: "mutating", protocol: "preview-apply", effect: "reversible-local", handlerKey: "migrate", ui: "diagnostic", exposure: "canonical" }),
